...
let
    ...
    @test which(m, Tuple{Any, Any, Int, Symbol}) == @which @macrotest 1 a
    @test which(m, Tuple{Any, Any, Int, Int}) == @which @macrotest 1 1

    @test first(methods(m, Tuple{Any, Any, Int, Int})) == @which MacroTest.@macrotest 1 1
